       ...
       >
          <Link to={`/tour/${tour.slug || tour.id}`} className="block">
             ...
             <div className="px-1 pb-2">
                <h4 className="text-base font-black text-gray-900 line-clamp-1 group-hover:text-emerald-600 transition-colors">{tour.title}</h4>
        ...
        >
          ...
          <div className={cn(
            ...
            <div className="absolute top-3 left-3 flex flex-col items-start gap-1.5 z-10 pointer-events-none">
              {imageLabel ? (
                ...
                <div className="rounded-md bg-emerald-600/90 backdrop-blur-md px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-white border border-emerald-500/20 shadow-sm">
                  Best Seller
                </div>
              )}
              {priceLabel && (
          ...
          <div className={cn(
            ...
            <div className="w-full space-y-1">
              <h3 className={cn(
                "font-black text-gray-900 leading-snug group-hover:text-emerald-600 transition-colors",
              ...
              <div className="flex flex-col min-w-0">
                <div className="flex items-baseline gap-1 flex-wrap">
                  <span className={cn(
                    ...
                    agentPrice ? "text-emerald-600" : "text-gray-900"
                  )}>
                ...
                {agentPrice ? (
                   <div className="flex items-center gap-1 flex-wrap mt-0.5 min-w-0">
                      <span className="text-[8px] font-black text-emerald-600 bg-emerald-50 px-1 py-0.5 rounded uppercase tracking-tighter truncate">Agent</span>
