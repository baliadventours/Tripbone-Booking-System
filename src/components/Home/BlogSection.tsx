          ...
          <section className="py-24 bg-gray-950 overflow-hidden">
             <div className="container mx-auto px-4 lg:px-8">
                <div className="text-center mb-16">
                   ...
                   <p className="text-emerald-400 font-bold tracking-widest uppercase text-xs">Stories from the core.</p>
                </div>
                      ...
                      <Link key={post.id} to={`/blog/${post.slug}`} className="group relative bg-white/5 rounded-[2.5rem] p-4 flex flex-col hover:bg-white/10 transition-colors border border-white/5">
                         ...
                         <div className="px-4 pb-4">
                            ...
                            <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
                               <span className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest">Active Thread</span>
                               <div className="h-8 w-8 rounded-full bg-emerald-400 text-gray-950 flex items-center justify-center -rotate-45 group-hover:rotate-0 transition-transform"><ArrowRight className="h-4 w-4" /></div>
                            </div>
                         </div>
                      </Link>
                   ))}
