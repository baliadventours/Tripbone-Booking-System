        ...
        return (
          <section className="py-24 bg-gray-950 overflow-hidden relative">
             <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
                <span className="text-emerald-400 font-black text-[10px] uppercase tracking-[0.3em] mb-4 block">Testimonials</span>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                   {reviews.map(review => (
                      <div key={review.id} className="bg-white/5 backdrop-blur-md p-10 rounded-[3rem] border border-white/10 text-left hover:bg-white/10 transition-colors">
                         <Quote className="h-8 w-8 text-emerald-400 mb-6" />
                         <p className="text-white font-medium text-lg mb-8 leading-relaxed italic">"{review.comment}"</p>
                         <div className="flex items-center gap-4">
                            <img src={review.userPhoto || 'https://i.pravatar.cc/100'} className="h-10 w-10 rounded-full border-2 border-emerald-400" alt={review.userName} />
                            <div>
