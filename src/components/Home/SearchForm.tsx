    ...
    >
      <form onSubmit={handleSearch} className="w-full">
        <div className={cn(
          ...
          <button 
            type="submit"
            className="bg-primary hover:bg-emerald-700 text-white font-black py-3 px-6 md:px-8 rounded-full shadow-md shadow-primary/20 hover:shadow-primary/30 active:scale-95 transition-all duration-200 text-xs md:text-sm uppercase tracking-widest flex items-center gap-2"
          >
            <span>Search</span>
          </button>
        </div>
