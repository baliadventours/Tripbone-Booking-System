      ...
      <div className="hidden md:grid grid-cols-4 grid-rows-2 gap-1 h-[600px]">
        ...
        >
          {images.length >= 5 ? (
            ...
            <div className="h-full w-full bg-emerald-50/30 flex flex-col items-center justify-center border-2 border-dashed border-emerald-100/50 group-hover:bg-emerald-50 transition-colors">
              <Plus className="h-6 w-6 text-emerald-200 group-hover:text-emerald-400 transition-colors" />
              <span className="text-[8px] font-black text-emerald-300 uppercase tracking-widest mt-2">More Photos</span>
            </div>
          )}
        </div>
      </div>
                  ...
                  {images.map((img, idx) => (
                    <button
                      ...
                      className={cn(
                        ...
                        idx === currentIndex 
                          ? "border-emerald-500 scale-105 opacity-100 ring-2 ring-emerald-500/20 shadow-lg" 
