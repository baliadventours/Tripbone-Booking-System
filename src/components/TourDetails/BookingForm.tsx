      ...
      <div id="package" className="rounded-[10px] border border-gray-100/80 bg-white p-6 shadow-[0_20px_50px_rgba(0,0,0,0.12),_0_0_1px_rgba(0,0,0,0.05)] scroll-mt-[116px]">
        ...
        <form id="tour-booking-form" onSubmit={handleAvailabilityCheck} className="space-y-6">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      selectedTime === time
                        ...
                        : "bg-gray-50 border-gray-100 text-gray-500 hover:border-emerald-200 hover:bg-white"
                    )}
                  >
                    {time}
                  </button>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-[50px] bg-primary py-5 font-black text-white hover:bg-emerald-700 hover:shadow-xl transition-all shadow-lg tracking-widest text-sm disabled:opacity-50 disabled:cursor-not-allowed"
          >
