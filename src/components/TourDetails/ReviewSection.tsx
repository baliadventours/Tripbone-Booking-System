    ...
    <div id="reviews" className="space-y-8 scroll-mt-[116px]">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 px-1">
        ...
        <button 
          ...
          className="flex items-center justify-center gap-2 bg-primary text-white px-6 py-3 rounded-full font-black text-xs uppercase tracking-widest shadow-lg shadow-emerald-100 active:scale-95 transition-all w-full md:w-auto"
        >
              ...
              {reviews.slice(0, 5).map((review) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-gray-50">
                    <div className="h-10 w-10 rounded-full bg-emerald-50 flex items-center justify-center text-primary font-black text-xs border border-emerald-100 overflow-hidden shrink-0">
                      {review.userPhoto ? (
                ...
                {reviews.map((review) => (
                  <div key={review.id} className="flex gap-4 md:gap-8 pb-8 border-b border-gray-50 last:border-0 last:pb-0">
                    <div className="shrink-0">
                      <div className="h-12 w-12 md:h-16 md:w-16 rounded-full bg-emerald-50 flex items-center justify-center text-primary font-black text-base border border-emerald-100 overflow-hidden shadow-sm">
                        {review.userPhoto ? (
                          <img src={review.userPhoto} className="w-full h-full object-cover" />
                        ) : (
              ...
              {auth.currentUser ? (
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8 no-scrollbar pb-10">
                  ...
                  <button
                    ...
                    className="w-full bg-primary text-white py-5 rounded-2xl font-black text-sm uppercase tracking-widest shadow-xl shadow-emerald-100 transition-all active:scale-[0.98] disabled:opacity-50"
                  >
                    {isSubmitting ? (
                ...
                <div className="p-12 text-center space-y-6">
                  ...
                  <button 
                    ...
                    className="bg-primary text-white px-8 py-4 rounded-full font-black text-xs uppercase tracking-widest shadow-lg shadow-emerald-100"
                  >
                    Sign In to Continue
                  </button>
                </div>
