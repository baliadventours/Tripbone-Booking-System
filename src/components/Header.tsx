      ...
      case 'modern-glass':
        return (
          <div className={cn(
            ...
            topNavStyle === 'modern-dark' ? "bg-gray-950 text-emerald-400" : "bg-emerald-950/95 text-emerald-100"
          )}>
        ...
        return (
          <div className={cn(headerClass, "h-24 md:h-28")}>
             <Link to="/" className="flex items-center">
                <img src={settings?.logoURL || '/logo.png'} className="h-10 w-auto" alt={settings?.siteName} width="160" height="40" />
             </Link>
        ...
        return (
          <div className={headerClass}>
            ...
            <nav className="hidden md:flex items-center gap-5">
              ...
              <Link to="/planner" className="relative text-sm font-black text-primary hover:text-emerald-700 transition-colors flex items-center gap-1">
                <Sparkles className="h-3 w-3" />
                Plan Your Trip
                <span className="absolute -top-3 -right-6 bg-emerald-500 text-[8px] text-white px-1.5 py-0.5 rounded-full animate-pulse uppercase tracking-widest">New</span>
              </Link>
          ...
          {showSearch && (
            ...
            >
              <form onSubmit={handleSearch} className="flex items-center gap-2">
                ...
                <button 
                  type="submit"
                  className="bg-primary text-white px-4 py-2.5 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-lg shadow-primary/10"
                >
                  Search
                </button>
              </form>
              ...
              >
                <div className="p-4 border-b border-gray-100 flex items-center justify-between">
                  ...
                  {notifications.length > 0 && (
                    <span className="text-[10px] font-black text-primary bg-emerald-50 px-2 py-0.5 rounded-full">
                    ...
                    notifications.map((notif) => (
                      ...
                      >
                        <div className={cn(
                          ...
                          notif.type === 'booking' ? "bg-blue-50 text-blue-500" : "bg-emerald-50 text-primary"
                        )}>
              ...
              >
                ...
                <div className="p-2">
                  <Link 
                    ...
                    className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-bold text-gray-600 hover:bg-emerald-50 hover:text-primary transition-all"
                  >
                    <Shield className="h-4 w-4" />
                    Dashboard
                  </Link>
        ...
        <div className="md:hidden flex flex-col bg-white px-4 py-3 border-b border-gray-100">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-base font-bold text-gray-900 tracking-tight text-center flex-1 mx-2">
              {location.pathname.startsWith('/tour/') ? 'Tour Details' : 'Bali Adventours'}
            </h1>
