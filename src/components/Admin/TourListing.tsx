      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="bg-primary text-white px-6 py-3 rounded-[10px] font-black text-xs flex items-center gap-2 shadow-lg shadow-emerald-200"
          >
              ...
              <div className="aspect-[4/3] w-full overflow-hidden relative">
                ...
                <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-all transform translate-y-2 group-hover:translate-y-0">
                  <button 
                    ...
                    className="p-3 bg-white/90 backdrop-blur rounded-[10px] text-emerald-600 shadow-xl hover:bg-emerald-600 hover:text-white transition-all" 
                    title="Clone Tour"
                  >
                ...
                <tr key={tour.id} className="hover:bg-gray-50/80 transition-colors group">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                       <button onClick={() => handleCloneTour(tour)} className="p-2 text-emerald-600 hover:bg-emerald-50 rounded-lg transition-all" title="Clone"><Copy className="h-4 w-4" /></button>
