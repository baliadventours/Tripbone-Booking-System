  ...
  return (
    <div className="space-y-6 text-gray-800 font-sans">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
          <div className="space-y-1">
            <h2 className="text-xl font-bold text-gray-900 tracking-tight flex items-center gap-2">
              <Icons.LayoutDashboard className="h-5 w-5 text-emerald-600" />
          ...
          <div className="flex flex-wrap items-center gap-2 bg-gray-50 p-1.5 rounded-xl border border-gray-100 self-start xl:self-auto">
            <button
              ...
              className={cn(
                ...
                viewMode === 'list' ? "bg-white text-emerald-700 shadow-sm border border-gray-200" : "text-gray-400 hover:text-gray-650"
              )}
            >
            ...
            <button
              ...
              className={cn(
                "px-4 py-2 rounded-lg text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer",
                viewMode === 'daily' ? "bg-white text-emerald-700 shadow-sm border border-gray-200" : "text-gray-400 hover:text-gray-650"
              )}
            >
            ...
            <button
              ...
              className={cn(
                "px-4 py-2 rounded-lg text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer",
                viewMode === 'calendar' ? "bg-white text-emerald-700 shadow-sm border border-gray-200" : "text-gray-400 hover:text-gray-650"
              )}
            >
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-11 pr-10 py-2.5 bg-gray-50 border border-gray-100 rounded-xl text-xs font-medium focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-50 outline-none transition-all"
            />
            {searchQuery && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-3 pt-3 border-t border-gray-50">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full bg-white border border-gray-200 rounded-lg px-2.5 py-2 text-xs font-medium outline-none text-emerald-700 font-semibold"
            >
      ...
      {selectedIds.length > 0 && (
        <div className="bg-emerald-950 text-white rounded-[16px] p-4 flex flex-col md:flex-row md:items-center justify-between gap-4 animate-in slide-in-from-bottom duration-300 shadow-xl border border-emerald-900 sticky bottom-4 z-40">
          <div className="flex items-center gap-3">
            <div className="h-6 w-6 rounded-full bg-emerald-700 text-white font-bold text-xs flex items-center justify-center">
              {selectedIds.length}
            </div>
            <div>
              <p className="text-xs font-bold leading-none">Selected bookings</p>
              <p className="text-[10px] text-emerald-300 font-medium mt-1">Perform bulk actions in 1 click across selected scope.</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 bg-emerald-700 hover:bg-emerald-600 text-[11px] font-bold rounded-lg transition-colors cursor-pointer"
            ...
            <div className="h-6 w-px bg-emerald-800 hidden md:block" />

            <div className="flex items-center gap-1">
              <select
                value={bulkGuide}
                onChange={e => setBulkGuide(e.target.value)}
                className="bg-emerald-900 border border-emerald-800 text-white text-[11px] font-bold rounded-lg px-2 py-1.5 focus:outline-none"
              >
              ...
              <button
                ...
                className="p-1 px-2.5 bg-emerald-600 hover:bg-emerald-500 rounded-lg text-xs font-bold transition-all"
                  ...
                  return (
                    <tr 
                      ...
                      className={cn(
                        ...
                        isRowSelected && "bg-emerald-50/[0.12] hover:bg-emerald-50/[0.18]"
                      )}
                      onClick={() => {
                    ...
                    >
                      ...
                      <td className="p-3">
                        <div className="flex flex-col gap-0.5">
                          <span className="font-mono text-[10px] font-bold text-emerald-600 select-all">
                            #{booking.id.slice(-8)}
                          </span>
                      ...
                      <td className="p-3">
                        <div className="max-w-[280px]">
                          <span className="font-black text-gray-900 block truncate group-hover:text-emerald-700 leading-tight">
                            {booking.tourTitle}
                          </span>
                          ...
                          {isRowSaving ? (
                            ...
                            <select
                              ...
                              className={cn(
                                ...
                                booking.status === 'confirmed' ? "bg-emerald-50 text-emerald-700 border-emerald-250" :
                      ...
                      <td className="p-3 text-center" onClick={e => e.stopPropagation()}>
                        <div className="flex items-center justify-center gap-1.5">
                          <button
                            ...
                            className="p-2 hover:bg-emerald-50 text-gray-600 hover:text-emerald-700 rounded-lg border border-gray-150 transition-colors"
          ...
          {filteredBookings.length > 0 && (
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 border-t border-gray-100 text-xs">
              ...
              <div className="flex items-center gap-1.5 font-bold text-gray-500">
                ...
                <span className="px-3 py-1 bg-gray-100 text-emerald-800 rounded-md">
          ...
          <div className="bg-white border border-gray-100 rounded-[20px] p-5 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs rounded-lg transition-colors flex items-center gap-1.5 shadow-sm cursor-pointer"
              >
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    "border-gray-150 hover:border-emerald-500"
                  )}
                >
                  <div className="space-y-2.5">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1.5 text-xs text-gray-500">
                        <Icons.Clock className="h-4 w-4 text-emerald-600" />
                    ...
                    <div>
                      ...
                      <h4 className="font-extrabold text-sm text-gray-900 group-hover:text-emerald-700 transition-colors line-clamp-2 mt-0.5">
                        {b.tourTitle}
                      </h4>
                    ...
                    <div className="bg-gray-50/60 p-2.5 rounded-lg border border-gray-100 text-xs space-y-1">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-black text-emerald-600 font-mono">{paxCount} Seats ({b.participants?.adults}A, {b.participants?.children}C)</span>
                      </div>
                      <div className="flex justify-between">
                    ...
                    {b.status === 'cancelled' ? (
                      ...
                      <div className="space-y-1.5">
                        <div className="flex items-center justify-between">
                          ...
                          {b.assignedGuideId ? (
                            <span className="text-[10px] font-semibold text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded">Dispatched</span>
                          ) : (
          ...
          <div className="bg-white border border-gray-100 rounded-[20px] p-5 shadow-sm">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-5">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={goToToday}
                  className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-xs rounded-lg transition-colors flex items-center gap-1 shadow-sm cursor-pointer"
                >
              ...
              {calendarDays.map((day, idx) => {
                ...
                return (
                  <div 
                    ...
                    className={cn(
                      "min-h-[100px] bg-white p-2.5 transition-all cursor-pointer relative flex flex-col justify-between hover:bg-emerald-50/[0.05]",
                      !isCurrentMonth && "bg-gray-50/15 text-gray-300",
                      isToday(day) && "bg-emerald-50/[0.04]"
                    )}
                  >
                    <div className="flex justify-between items-start">
                      <span className={cn(
                        "text-xs font-black transition-colors",
                        !isCurrentMonth ? "text-gray-300" : isToday(day) ? "text-emerald-600 font-black text-sm" : "text-gray-650",
                      ...
                      {dayBookings.length > 0 && isCurrentMonth && (
                        <span className={cn(
                          ...
                          dayBookings.some(b => b.status === 'pending') ? "bg-amber-500 animate-pulse" : "bg-emerald-500"
                        )} />
                      )}
                    </div>
