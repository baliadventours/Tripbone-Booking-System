      ...
      >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectedTourIds.includes(tour.id) 
                      ? "bg-emerald-50 border-primary shadow-sm" 
        ...
        <div className="p-8 bg-gray-50/50 border-t border-gray-100">
           {loading ? (
             ...
             <button 
               onClick={handleApply}
               className="w-full py-5 bg-primary text-white rounded-[15px] font-black text-sm tracking-widest uppercase shadow-xl shadow-emerald-100 hover:bg-emerald-700 transition-all flex items-center justify-center gap-3"
             >
