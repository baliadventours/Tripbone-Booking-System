              ...
              webTickets.map((t) => (
                <button
                  ...
                  className={cn(
                    ...
                    t.id === activeWebTicketId ? "border-l-emerald-500 bg-emerald-50/10" : "border-l-transparent"
                  )}
                >
        ...
        <div className="lg:col-span-8 bg-white border border-gray-100 rounded-[20px] shadow-sm flex flex-col overflow-hidden min-h-[500px]">
          {activeWebTicket ? (
              ...
              <div className="p-5 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gray-50/50">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <select
                    ...
                    className="text-xs font-bold bg-white border border-gray-200 rounded-[8px] px-3 py-1.5 focus:outline-none focus:border-emerald-500"
                  >
              ...
              <div className="p-4 border-t border-gray-100 bg-white">
                <form onSubmit={handleWebReplySubmit} className="flex gap-3">
                  ...
                  <button
                    ...
                    className="p-3 bg-emerald-500 hover:bg-emerald-600 disabled:bg-gray-100 disabled:text-gray-400 text-white rounded-[12px] transition-all cursor-pointer font-bold uppercase tracking-wider text-xs shrink-0"
                  >
            ...
            <div className="flex-grow flex flex-col items-center justify-center p-8 text-center text-gray-300 h-[500px]">
              <LifeBuoy className="h-12 w-12 text-emerald-100 mb-3 animate-bounce" />
