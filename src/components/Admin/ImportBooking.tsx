        ...
        <div className="p-8">
          {activeTab === 'ai' ? (
            <div className="space-y-6">
              <div className="p-6 bg-emerald-50 rounded-[20px] border border-emerald-100 flex items-start gap-4">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-primary text-white py-5 rounded-[18px] font-black text-sm tracking-widest uppercase shadow-xl hover:shadow-emerald-200 active:scale-[0.98] transition-all disabled:opacity-50 disabled:grayscale flex items-center justify-center gap-3"
                >
                  {isExtracting ? (
                    <>
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="pt-10 flex gap-4">
                ...
                <button
                  type="submit"
                  className="flex-1 bg-primary text-white py-5 rounded-[18px] font-black text-sm tracking-widest uppercase shadow-xl hover:shadow-emerald-200 active:scale-[0.98] transition-all flex items-center justify-center gap-3"
                >
