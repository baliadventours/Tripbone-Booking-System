  ...
  return (
    <div className="space-y-8 animate-fadeIn text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span className="px-2.5 py-0.5 text-[10px] font-black uppercase rounded-full bg-emerald-50 text-emerald-700 border border-emerald-100 flex items-center gap-1.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Card 1: Active now */}
        <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-xs relative overflow-hidden group hover:border-emerald-200 transition-all">
          <div className="flex justify-between items-start mb-4">
            <div className="p-3 rounded-2xl bg-emerald-50 text-emerald-600">
              <Users className="h-6 w-6 animate-pulse" />
            </div>
            <span className="text-[10px] uppercase font-black tracking-wider text-emerald-600 bg-emerald-50/50 px-2 py-0.5 rounded-lg border border-emerald-50">
              Visitor Pulse
            </span>
          </div>
        ...
        <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-xs flex flex-col justify-between">
          ...
          <div className="pt-4 border-t border-gray-50 bg-gray-50/20 -mx-6 -mb-6 p-6 rounded-b-3xl">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-emerald-800">Tracking systems fully operational</span>
            </div>
          </div>
        </div>
