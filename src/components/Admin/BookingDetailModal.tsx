                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-xs space-y-4">
                    <div>
                      ...
                      <p className="text-[10px] text-emerald-600 font-extrabold uppercase mt-0.5">
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="p-2 bg-primary text-white rounded-lg hover:bg-emerald-600 transition-colors disabled:opacity-35"
                    >
            ...
            <div className="p-4 border-t border-gray-100 bg-gray-55 space-y-3 shrink-0">
              <div className="flex gap-2">
                <button
                  ...
                  className="p-3 rounded-lg border border-primary text-primary hover:bg-emerald-50 transition-colors"
                ...
                {isAdmin && (
                  <button
                    ...
                    className="flex-[2] bg-primary text-white p-3 rounded-lg text-xs font-black tracking-widest hover:bg-emerald-700 transition-all disabled:opacity-50 flex items-center justify-center gap-1"
                  >
