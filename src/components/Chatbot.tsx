...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { 
      role: 'model', 
      parts: "Halo! I'm Didi, your Bali Adventours assistant. Selamat Datang to Bali! \n\nWhat we can help you today?\n1. **Check a booking status**\n2. **Book a tour**\n3. **General Questions**\n4. **Chat with Real Person**" 
    }
  ]);
    ...
    <div className={cn(
          ...
          >
            ...
            <div className="p-6 bg-emerald-600 text-white flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-black text-xs uppercase tracking-widest">Didi Assistant</h3>
                  <p className="text-[10px] font-medium text-emerald-100 italic">Online & ready to help</p>
                </div>
              </div>
              <button 
              ...
              {messages.map((m, i) => (
                ...
                >
                  <div className={cn(
                    ...
                    <div className="markdown-content prose prose-sm prose-emerald max-w-none text-inherit">
                      <Markdown
                        components={{
                          a: ({ node, ...props }) => (
                            <a 
                              ...
                              target="_blank" 
                              rel="noreferrer" 
                              className="text-emerald-600 font-bold underline hover:text-emerald-700 transition-colors cursor-pointer"
            ...
            <div className="p-4 bg-white border-t border-gray-100 flex gap-2">
              <input
                ...
                className="flex-1 bg-gray-50 border border-gray-100 rounded-[20px] px-4 py-3 text-xs focus:outline-none focus:ring-2 focus:ring-emerald-500/20 placeholder:text-gray-400"
              />
              <button
                onClick={handleSend}
                disabled={!input.trim() || isLoading}
                className="p-3 bg-emerald-600 text-white rounded-full hover:bg-emerald-700 transition-colors disabled:opacity-50"
              >
      ...
      <button
        ...
        className={cn(
          ...
          isOpen ? "bg-white text-gray-900 rotate-90 flex" : "bg-emerald-600 text-white",
