    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="min-w-[600px] grid grid-cols-1 md:grid-cols-2 gap-4">
                  {tour.packages.map((pkg, pIdx) => (
                    <div key={pIdx} className="bg-white border border-gray-50 rounded-xl p-3 flex flex-col gap-2">
                      ...
                      {pkg.meetingPoint && (
                        <div className="flex items-start gap-2 px-1 py-1 bg-emerald-50/50 rounded-lg border border-emerald-100/30">
                      ...
                      <div className="grid grid-cols-3 gap-1">
                        ...
                        {pkg.tiers.map((tier, tIdx) => (
                          <React.Fragment key={tIdx}>
                            ...
                            <div className="px-2 py-1.5 bg-emerald-50/30 rounded text-right text-[11px] font-black text-primary">
      ...
      <div className="mt-16 text-center text-gray-400">
        ...
        <p className="text-xs italic leading-relaxed max-w-sm mx-auto mb-6">
          Still confused about the best option for your group? Talk to Didi, our AI travel assistant.
        </p>
        <button 
