...
export default function Bookings() {
  ...
  const getStatusStyles = (status: string, date: string) => {
    ...
    return { label: 'Confirmed', icon: CheckCircle2, className: 'bg-emerald-50 text-emerald-600' };
  };
                    ...
                    <div className="mt-6 flex flex-wrap items-center gap-3">
                      ...
                      {booking.status === 'confirmed' && (
                        <button 
                          ...
                          className="flex items-center gap-2 px-6 py-3 bg-emerald-50 text-[#00A651] rounded-xl text-xs font-bold hover:bg-emerald-100 transition-all shadow-sm active:scale-95"
                        >
                      ...
                      {booking.status !== 'cancelled' && !isCompleted && (
                        <div className="flex gap-2 sm:ml-auto w-full sm:w-auto mt-2 sm:mt-0 pt-4 sm:pt-0 border-t sm:border-0 border-gray-100">
                          <button 
                            ...
                            className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-6 py-3 bg-white border border-emerald-100 text-[#00A651] rounded-xl text-xs font-bold hover:bg-emerald-50 transition-all active:scale-95 shadow-sm"
                          >
                  ...
                  <div className="flex items-center gap-2">
                    {selectedBooking.status === 'confirmed' && (
                      <button 
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-emerald-50 text-[#00A651] rounded-xl text-xs font-bold hover:bg-emerald-100 transition-all"
                      >
                        <QrCode className="h-4 w-4" />
                        Print Voucher
                      </button>
            ...
            >
              <form onSubmit={handleEditSubmit}>
                ...
                <div className="p-8 overflow-y-auto max-h-[60vh] space-y-8">
                          ...
                          return (
                            <div 
                              ...
                              className={cn(
                                ...
                                selected ? "border-[#00A651] bg-emerald-50/30" : "border-gray-50 hover:border-gray-100 bg-white"
                              )}
                              onClick={() => {
                                if (selected) {
                            ...
                            >
                              ...
                              {selected && (
                                <div className="mt-4 pt-4 border-t border-emerald-100 flex items-center justify-between" onClick={e => e.stopPropagation()}>
                                  <p className="text-[10px] font-black text-emerald-600 uppercase">Quantity</p>
                  ...
                  {recalculatedSummary && (
                    <div className="p-6 bg-emerald-50 rounded-[24px] border border-emerald-100 flex items-center justify-between">
                       <div>
                         <p className="text-[10px] font-black text-emerald-600 uppercase tracking-widest mb-1">Estimated Total</p>
                         <div className="flex items-baseline gap-2">
                            <span className="text-2xl font-black text-emerald-700">${recalculatedSummary.total}</span>
                            {recalculatedSummary.total !== editingBooking.totalAmount && (
                              <div className="flex flex-col">
                                <span className={cn("text-[10px] font-black uppercase", recalculatedSummary.total > editingBooking.totalAmount ? "text-red-500" : "text-emerald-600")}>
                       ...
                       <div className="text-right">
                          <p className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest leading-none mb-1">Rates</p>
                          <p className="text-[10px] text-emerald-600 font-medium">${recalculatedSummary.adultRate}/adult, ${recalculatedSummary.childRate}/child</p>
                          <p className="text-[10px] text-emerald-600 font-black mt-1">+${recalculatedSummary.addonsTotal} Add-ons</p>
                       </div>
                    </div>
                  )}
                </div>
                ...
                <div className="p-8 bg-gray-50/50 flex gap-4">
                  ...
                  <button 
                    ...
                    className="flex-[2] py-4 bg-[#00A651] text-white rounded-[16px] font-bold text-sm hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-100 disabled:opacity-50 flex items-center justify-center gap-2"
                  >
