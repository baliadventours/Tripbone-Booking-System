        ...
        <div className="lg:hidden bg-white border-b border-gray-150 flex flex-col w-full z-20 shadow-xs">
          ...
          <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-gray-50 to-white">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-emerald-500 to-teal-600 text-white flex items-center justify-center font-black text-sm shadow-inner border border-emerald-100">
            ...
            <div className="flex items-center gap-2">
              <div className="bg-emerald-50 text-[#00A651] border border-emerald-100/60 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider flex items-center gap-1 shadow-xs">
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) => cn(
                    ...
                    isActive 
                      ? "bg-[#00A651] text-white border-[#00A651] shadow-sm shadow-emerald-100" 
