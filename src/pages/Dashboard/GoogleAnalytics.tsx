      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <span className="px-2.5 py-0.5 text-[10px] font-bold rounded-full bg-emerald-50 text-emerald-700 border border-emerald-100 flex items-center gap-1">
      ...
      <AnimatePresence>
        {successMessage && (
          <motion.div 
            ...
            exit={{ opacity: 0, y: -10 }}
            className="bg-emerald-50 border border-emerald-100 text-emerald-800 text-xs px-4 py-3 rounded-xl flex items-center gap-2.5 shadow-sm"
          >
        ...
        <div className="bg-white border border-gray-150 rounded-2xl p-6 shadow-xs flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4">
              <div className="p-2.5 bg-emerald-50 rounded-xl text-[#00A651]">
              ...
              <span className={`text-[10px] uppercase font-black tracking-wider px-2.5 py-0.5 rounded-full border ${
                measurementId || customScript 
                  ? 'text-emerald-700 bg-emerald-50/50 border-emerald-100 flex items-center gap-1.5' 
...
<script>
  ...
  gtag('config', 'G-XXXXXXXX');
              ...
              <button 
                type="submit"
                className="w-full text-center py-2.5 bg-[#00A651] hover:bg-emerald-600 font-bold hover:shadow-md text-xs font-black text-white rounded-xl shadow-xs transition-all cursor-pointer flex items-center justify-center gap-2"
              >
            ...
            <div className="space-y-2 bg-gray-50 rounded-xl p-3 border border-gray-100">
              ...
              <div className="space-y-1.5 text-xs">
                <div className="flex justify-between text-gray-800">
                  <span className="font-mono text-emerald-700 font-bold">/tours (Tour Explorer)</span>
                  <span className="font-black">{Math.max(2, Math.floor(activeUsersCount * 0.4))}</span>
                </div>
                <div className="flex justify-between text-gray-800">
                  <span className="font-mono text-emerald-700 font-bold">/planner (AI Planner)</span>
                  <span className="font-black">{Math.max(1, Math.floor(activeUsersCount * 0.3))}</span>
                </div>
                <div className="flex justify-between text-gray-800">
                  <span className="font-mono text-emerald-700 font-bold">/ (Home Page)</span>
        ...
        <div className="bg-white border border-gray-150 rounded-2xl p-6 shadow-xs text-left">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-emerald-50 text-[#00A651] flex items-center justify-center font-black text-xs">
                1
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="w-full h-1.5 bg-emerald-100/50 rounded-full mt-1.5 overflow-hidden">
                ...
                <div className="space-y-2">
                  {liveEvents.map((evt, idx) => (
                    <div key={idx} className="p-2 bg-white rounded border border-gray-100 space-y-1">
                      ...
                      {evt.params && (
                        <div className="text-[8.5px] text-emerald-700 bg-emerald-50/40 p-1.5 rounded border border-emerald-100/30 overflow-x-auto whitespace-pre">
