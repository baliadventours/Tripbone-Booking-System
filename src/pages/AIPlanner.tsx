...
export default function AIPlanner() {
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.name.trim()) {
      alert("Please provide your name so Didi knows how to greet you.");
      setCurrentStage(0);
      return;
    }
        ...
        <div className="relative h-[340px] md:h-[420px] flex items-center justify-center text-center overflow-hidden print:hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 max-w-3xl">
            <motion.div
              ...
              className="space-y-4"
            >
              <div className="inline-flex items-center gap-2 bg-emerald-500/25 backdrop-blur-md text-emerald-300 px-4 py-1.5 rounded-full text-xs font-bold tracking-wider border border-emerald-400/30">
                <Sparkles className="h-3 w-3 animate-pulse text-emerald-400" />
                Didi's Professional AI Blueprint
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                {itinerary.dailyPlans.map((day, idx) => (
                  ...
                  >
                    <span className={cn(
                      ...
                      activeDayIdx === idx ? "bg-white text-emerald-600" : "bg-zinc-200 text-zinc-700"
                    )}>
                      {day.day}
                    </span>
                    Day {day.day}
                ...
                {itinerary.dailyPlans.map((day, dayIdx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-6 md:p-8 bg-gradient-to-r from-zinc-50 to-white border-b border-zinc-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                          <div className="flex items-center gap-2 mb-1.5">
                            <span className="text-[10px] font-extrabold text-emerald-600 uppercase tracking-widest bg-emerald-50 px-2.5 py-1 rounded-full">
                          ...
                          <div key={idx} className="relative flex flex-col md:flex-row gap-4 md:gap-8 items-start hover:bg-zinc-50/50 p-2 rounded-2xl transition-all">
                            ...
                            <div className="flex items-center gap-4 shrink-0">
                              <div className={cn(
                                ...
                                activity.type === 'activity' ? "bg-emerald-50 text-emerald-600 border-emerald-100" :
                            ...
                            <div className="flex-1 md:pt-1">
                              <h3 className="text-base font-bold text-zinc-900 mb-1 flex items-center gap-2">
                                ...
                                <span className={cn(
                                  ...
                                  activity.type === 'activity' ? "bg-emerald-100 text-emerald-800" :
                      ...
                      {/* Elegant Stay Box */}
                      <div className="m-6 p-6 bg-emerald-50/30 rounded-2xl border border-emerald-500/10 flex flex-col md:flex-row gap-5 items-start">
                        <div className="h-12 w-12 rounded-xl bg-white shadow-sm flex items-center justify-center text-emerald-600 shrink-0 border border-emerald-100">
                          <HomeIcon className="h-6 w-6" />
                        </div>
                        <div className="flex-1">
                          <p className="text-[9px] font-black text-emerald-600/70 uppercase tracking-widest mb-1">Recommended Stay</p>
                          ...
                          {day.accommodationRecommendation.estimatedPrice && (
                            <div className="mt-3 inline-flex items-center gap-2 px-3 py-1 bg-white rounded-full border border-emerald-100/60 shadow-sm">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white rounded-3xl shadow-sm border border-zinc-100 p-6">
                ...
                <p className="text-xs text-zinc-400 font-medium mb-4">Didi has linked these proprietary private tours with your passion details:</p>
                  ...
                  {itinerary.recommendedTours && itinerary.recommendedTours.length > 0 ? (
                    itinerary.recommendedTours.map((rec) => (
                      <Link 
                        ...
                        className="block group bg-zinc-50 rounded-2xl p-4 hover:bg-emerald-600 transition-all duration-300"
                      >
                        <h4 className="text-sm font-extrabold text-zinc-800 group-hover:text-white transition-colors mb-1">
                          {rec.title}
                        </h4>
                        <p className="text-[11px] text-zinc-500 group-hover:text-emerald-100/90 transition-colors leading-relaxed font-semibold">
                          {rec.reason}
                        </p>
                        <div className="mt-3 flex items-center gap-1 text-[9px] font-black uppercase text-emerald-600 group-hover:text-white transition-colors">
                    ...
                    <div className="text-center py-6 text-zinc-400 text-xs">
                      No matching set tours found. Contact Didi via WhatsApp for a custom invoice!
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="space-y-3.5">
                  {itinerary.travelTips.map((tip, i) => (
                    <div key={i} className="flex gap-2.5 items-start">
                      <div className="h-5 w-5 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0 mt-0.5 text-[10px] font-black">
                        {i + 1}
                      </div>
  ...
  return (
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center px-4 py-28 relative overflow-hidden font-sans text-zinc-800">
      ...
      <div className="absolute top-0 right-0 w-[550px] h-[550px] bg-emerald-100/40 rounded-full blur-[120px] -z-10 translate-x-1/3 -translate-y-1/3" />
      <div className="absolute bottom-0 left-0 w-[550px] h-[550px] bg-emerald-100/30 rounded-full blur-[120px] -z-10 -translate-x-1/3 translate-y-1/3" />
          ...
          {isGenerating ? (
            ...
            >
              <div className="relative inline-block">
                <div className="absolute inset-0 bg-emerald-500/25 rounded-full blur-3xl animate-pulse" />
              ...
              <div className="space-y-4">
                <h2 className="text-3xl md:text-4xl font-black text-zinc-900 tracking-tight leading-tight">
                  Didi is drafting your <span className="text-emerald-600">dream trip...</span>
                </h2>
              ...
              <div className="lg:col-span-4 flex flex-col justify-between bg-white rounded-3xl p-6 shadow-sm border border-zinc-100 lg:sticky lg:top-28">
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-11 h-11 bg-emerald-500 rounded-2xl flex items-center justify-center shadow-md shadow-emerald-500/10">
                      <Sparkles className="h-5 w-5 text-white" />
                    </div>
                    <div>
                      <span className="text-[10px] font-black text-emerald-600 uppercase tracking-wider block">Co-Pilot Assistant</span>
                      <h3 className="font-bold text-zinc-950 text-sm">Meet Host Didi</h3>
                    </div>
                  </div>
                  ...
                  <div className="bg-zinc-50 rounded-2xl p-4 border border-zinc-100 text-xs font-semibold text-zinc-600 leading-relaxed mb-6 relative">
                    ...
                    "Halo! I have lived in Bali for decades. Type your wishes & I will merge local intelligence with smart AI models to build a custom travel blueprint."
                  </div>
                  ...
                  <div className="border border-dashed border-zinc-200 rounded-2xl p-5 bg-gradient-to-br from-zinc-50 to-white relative overflow-hidden">
                    ...
                    <div className="space-y-3.5 text-xs text-zinc-700">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-extrabold text-emerald-600">{formData.duration} Days</span>
                      </div>
                      <div className="flex justify-between items-center">
                    ...
                    {STAGES.map((s, idx) => (
                      <button
                        ...
                        className={cn(
                          ...
                          idx === currentStage 
                            ? "border-emerald-500 text-zinc-950 font-black" 
                            : idx < currentStage
                            ? "border-emerald-200 text-emerald-600 font-bold"
                            : "border-transparent text-zinc-400 hover:text-zinc-650"
                        )}
                      >
                        <s.icon className={cn(
                          "h-4 w-4 shrink-0",
                          idx === currentStage ? "text-emerald-500" : "text-zinc-400"
                        )} />
                        <div>
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-4">
                            <div className="space-y-2">
                              ...
                              <input 
                                type="text"
                                className="w-full bg-zinc-50 border border-zinc-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 rounded-xl px-4 py-3 text-sm font-bold text-zinc-900 outline-none transition-all"
                            ...
                            <div className="space-y-2">
                              <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1.5">
                                <Globe className="h-3.5 w-3.5 text-emerald-500" /> Coming From
                              </label>
                              <input 
                                type="text"
                                className="w-full bg-zinc-50 border border-zinc-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 rounded-xl px-4 py-3 text-sm font-bold text-zinc-900 outline-none transition-all"
                            ...
                            <div className="space-y-2">
                              <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1.5">
                                <Phone className="h-3.5 w-3.5 text-emerald-500" /> WhatsApp Number (Optional)
                              </label>
                              <input 
                                type="tel"
                                className="w-full bg-zinc-50 border border-zinc-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 rounded-xl px-4 py-3 text-sm font-bold text-zinc-900 outline-none transition-all"
                      ...
                      {currentStage === 1 && (
                        <div className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                            <div className="space-y-2">
                              <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1.5">
                                <Calendar className="h-3.5 w-3.5 text-emerald-500" /> Estimated Timeline / Month
                              </label>
                              <input 
                                type="text"
                                className="w-full bg-zinc-50 border border-zinc-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 rounded-xl px-4 py-3 text-sm font-bold text-zinc-900 outline-none transition-all"
                            ...
                            <div className="space-y-2">
                              <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1.5">
                                <Clock className="h-3.5 w-3.5 text-emerald-500" /> Journey Duration (Days)
                              </label>
                            ...
                            <div className="space-y-2 md:col-span-2">
                              <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1.5">
                                <Users className="h-3.5 w-3.5 text-emerald-500" /> Group Size / Crew count
                              </label>
                            ...
                            <div className="space-y-2 md:col-span-2">
                              <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1.5">
                                <Wallet className="h-3.5 w-3.5 text-emerald-500" /> Daily Budget Level
                              </label>
                      ...
                      {currentStage === 2 && (
                        <div className="space-y-6">
                          ...
                          <div className="space-y-5 pt-4">
                            ...
                            <div className="space-y-2">
                              <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1.5">
                                <Compass className="h-3.5 w-3.5 text-emerald-500" /> Trip General Vibe Focus
                              </label>
                            ...
                            <div className="space-y-2">
                              <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1.5 justify-between">
                                <span className="flex items-center gap-1.5"><MapPin className="h-3.5 w-3.5 text-emerald-500" /> Preferred Beach Hub / Villages</span>
                              ...
                              <input 
                                type="text"
                                className="w-full bg-zinc-50 border border-zinc-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 rounded-xl px-4 py-3 text-xs font-bold text-zinc-800 outline-none transition-all mt-2"
                            ...
                            <div className="space-y-2">
                              <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1.5">
                                <HomeIcon className="h-3.5 w-3.5 text-emerald-500" /> Preferred Habitation Type
                              </label>
                      ...
                      {currentStage === 3 && (
                        <div className="space-y-6">
                          ...
                          <div className="space-y-4 pt-4">
                            ...
                            {/* Food Preferences */}
                            <div className="space-y-2">
                              <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1"><Utensils className="h-3.5 w-3.5 text-emerald-500" /> Dietary Focus & Culinary Preference</label>
                              <div className="flex flex-wrap gap-1.5">
                              ...
                              <input 
                                type="text"
                                className="w-full bg-zinc-50 border border-zinc-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 rounded-xl px-4 py-3 text-xs font-bold text-zinc-800 outline-none transition-all mt-1"
                            ...
                            <div className="space-y-2">
                              <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1">
                                <Sparkles className="h-3.5 w-3.5 text-emerald-500" /> Key Landmarks You Don't Want to Miss
                              </label>
                              <div className="flex flex-wrap gap-1.5">
                ...
                <div className="flex items-center justify-between pt-8 mt-10 border-t border-zinc-100">
                    ...
                    {STAGES.map((_, idx) => (
                      <div 
                        ...
                        className={cn(
                          ...
                          idx === currentStage ? "w-8 bg-emerald-500" : idx < currentStage ? "w-3 bg-emerald-300" : "w-1.5 bg-zinc-180"
                        )}
                      />
                    ))}
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button 
                      type="button"
                      onClick={handleNext}
                      className="bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-3 rounded-xl text-xs font-black uppercase tracking-wider transition-all flex items-center gap-2 shadow-md shadow-emerald-500/10"
                    >
