                   ...
                   <div className="space-y-4">
                      {booking.status === 'confirmed' ? (
                        <Link 
                          ...
                          className="w-full h-16 bg-emerald-500 text-white rounded-2xl flex items-center justify-center gap-3 font-black text-sm uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-xl shadow-emerald-100"
                        >
                      ...
                      <div className="text-center pt-8">
                        ...
                        <div className="flex justify-center gap-4">
                           <a href={`mailto:${settings?.supportEmail || 'support@baliadventours.com'}`} className="h-12 px-6 bg-white border border-gray-100 text-gray-900 rounded-xl flex items-center gap-2 text-[10px] font-black uppercase tracking-widest hover:border-primary transition-all">
