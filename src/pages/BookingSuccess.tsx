                ...
                {booking.status === 'pending' || booking.status === 'review_required' ? (
                  <>
                    ...
                    <div className="pt-6 border-t border-gray-100">
                      <p className="text-xs italic bg-emerald-50 text-emerald-700 p-4 rounded-xl">
              ...
              <div className="space-y-10">
                ...
                <div className="grid grid-cols-2 gap-8 voucher-section">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <p className="text-base font-black text-emerald-500">Fully Paid</p>
                  </div>
                </div>
                    ...
                    <div className="space-y-3">
                       {settings?.supportPhone && (
                         <button 
                           ...
                           className="flex items-center gap-3 w-full p-3 rounded-xl bg-emerald-50 text-emerald-700 hover:bg-emerald-100 transition-all text-xs font-black uppercase tracking-tight"
                         >
