      ...
      <div className="bg-white border-b border-gray-100 py-12 md:py-16 mb-12">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-50 text-emerald-800 rounded-full border border-emerald-100/60">
              <Compass className="h-3.5 w-3.5 text-emerald-600" />
              <span className="text-[10px] font-extrabold uppercase tracking-widest text-emerald-800">Verified Travel Advisory Hub</span>
            </div>
            
            <div className="space-y-3">
              <h1 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tight leading-none font-sans">
                Bali Advisory &amp; <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-700">Expert Concierge</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-5 bg-emerald-50/50 border border-emerald-100/60 rounded-2xl">
              <span className="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-700 flex-shrink-0">
                <CheckCircle className="h-5 w-5" />
              </span>
              <div>
                <h4 className="text-sm font-black text-emerald-950 font-sans tracking-tight">Verified Locally &amp; Built for Smart Travel</h4>
                <p className="text-xs text-emerald-800/80 font-medium leading-relaxed mt-0.5">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              ...
              <button
                ...
                className={cn(
                  "px-5 py-2.5 rounded-xl text-xs font-black transition-all flex items-center gap-2 border border-emerald-600/20",
                  activeSegment === 'concierge' ? "bg-emerald-600 text-white border-emerald-600 shadow-md shadow-emerald-600/25" : "bg-emerald-50/50 hover:bg-emerald-50 text-emerald-800"
                )}
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredTips.map(tip => (
                  <div key={tip.id} className="bg-white border border-gray-100 hover:border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    <div className="space-y-3">
                      <span className="inline-block px-2.5 py-1 bg-emerald-50 text-emerald-800 rounded-lg text-[10px] font-extrabold uppercase tracking-widest">
                        {tip.category}
                      </span>
            ...
            <div className="bg-white border border-gray-100 p-6 md:p-8 rounded-2xl shadow-sm space-y-6">
              ...
              <form onSubmit={handleAskConcierge} className="flex gap-2">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-emerald-600 text-white hover:bg-emerald-700 transition-all rounded-xl text-xs font-black flex items-center gap-2"
                >
                  {conciergeLoading ? (
                    <>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {conciergeSources.map((src, idx) => (
                          <a 
                            ...
                            className="inline-flex items-center gap-1 px-2.5 py-1 bg-white border border-gray-200 hover:border-emerald-200 hover:text-emerald-600 transition-all text-[10px] font-bold text-gray-500 rounded-lg"
                          >
