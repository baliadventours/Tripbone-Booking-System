  ...
  if (!post) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-white p-6 text-center">
        ...
        <Link to="/blog" className="px-8 py-4 bg-primary text-white font-black rounded-[10px] text-xs hover:bg-emerald-700 transition-all">
          Back to blog
        </Link>
      </div>
    );
              ...
              {(() => {
                ...
                return (
                  <div ref={contentRef} className="space-y-12">
                    <div 
                      className="prose prose-lg prose-emerald max-w-none font-medium text-gray-600 leading-[1.8]
                    ...
                    {matchedTours.length > 0 && (
                      <div className="my-12 bg-gray-50/70 border border-gray-100/80 rounded-3xl p-6 md:p-8 space-y-6 shadow-sm">
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                          <div>
                            <span className="text-[#00A651] font-black text-[10px] uppercase tracking-wider bg-emerald-50 px-3 py-1 rounded-full">
                              Featured Adventures
                            </span>
