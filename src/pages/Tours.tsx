      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-gray-50/70 via-gray-50/20 to-white pt-28 pb-16 border-b border-gray-100/80">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-50 text-emerald-700 text-[10px] font-black uppercase tracking-widest rounded-full mb-4 shadow-sm border border-emerald-100/40">
      ...
      <section className="container mx-auto px-4 py-12 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <aside className="lg:w-72 flex-shrink-0 animate-fadeIn">
            ...
            >
              <span className="flex items-center gap-2"><Filter className="h-4 w-4 text-emerald-600" /> Filters & Categories</span>
            ...
            <div className={cn(
              ...
              <div className="space-y-2 pb-5 border-b border-gray-200/60">
                ...
                <div className="relative group/search">
                  <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 group-focus-within/search:text-emerald-600 transition-colors" />
                  <input 
                    type="text"
                    placeholder="Search adventures..."
                    value={searchTerm}
                    onChange={e => setSearchTerm(e.target.value)}
                    className="w-full bg-white border border-gray-200/80 rounded-xl py-2.5 pl-10 pr-9 focus:outline-none focus:ring-2 focus:ring-emerald-500/10 focus:bg-white focus:border-emerald-600/30 transition-all text-xs font-black text-gray-900 placeholder:text-gray-400 shadow-sm"
                  />
                  {searchTerm && (
                    <button 
              ...
              <div className="space-y-2 pb-5 border-b border-gray-200/60">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full appearance-none bg-white hover:bg-white border border-gray-200 hover:border-gray-300 rounded-xl py-2.5 pl-3.5 pr-10 text-xs font-black text-gray-900 cursor-pointer focus:outline-none focus:ring-2 focus:ring-emerald-500/10 focus:bg-white focus:border-emerald-600/30 transition-all shadow-sm"
                  >
                ...
                <div className="space-y-1 max-h-52 overflow-y-auto pr-1 scrollbar-thin">
                  ...
                  >
                    <span className="flex items-center gap-2">
                      <Compass className="h-4 w-4 shrink-0 text-emerald-600 group-hover:scale-110 duration-200 transition-transform" />
                      <span>All Types</span>
                    </span>
                    {selectedCategory === 'all' && (
                          ...
                          {cat.icon && (
                            <div className="shrink-0 flex items-center justify-center">
                              {cat.icon.startsWith('http') ? (
                                ...
                                return <IconComponent className="h-4 w-4 text-emerald-600 group-hover:scale-110 duration-200 transition-transform" />;
                              })()}
                            </div>
                          )}
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-black text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100/30"><FormattedPrice amount={priceRange} /></span>
                </div>
                <input 
                  type="range"
                  min="50"
                  ...
                  className="w-full h-1.5 rounded-lg appearance-none cursor-pointer bg-gray-200 accent-emerald-600 focus:outline-none"
                />
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  <select
                    ...
                    className="appearance-none bg-white border border-gray-150 rounded-2xl py-2.5 pl-4 pr-10 text-xs font-black text-gray-900 cursor-pointer focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-gray-300 transition-all text-right shadow-sm"
                  >
                  ...
                  <div className="space-y-16">
                    ...
                    >
                      <div className="relative mb-6">
                        <div className="absolute inset-0 bg-emerald-100 rounded-full blur-xl opacity-40 animate-pulse" />
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3.5 bg-gray-900 hover:bg-emerald-600 text-white transition-all text-[10px] font-black uppercase tracking-widest rounded-xl shadow-lg shadow-gray-950/10 active:scale-97 cursor-pointer"
                      >
                    ...
                    {tours.length > 0 && (
                      ...
                      >
                        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
                          <div>
                            <span className="text-[10px] font-black text-emerald-600 uppercase tracking-widest block mb-1">Recommended for you</span>
                          ...
                          <button 
                            ...
                            className="text-[10px] font-black text-emerald-600 hover:text-emerald-800 uppercase tracking-widest flex items-center gap-1.5 transition-colors self-start"
                          >
